    ...
    return (
        <div className="login-page-container">
            <div className="login-page-responsive">
                ...
                <p className="logincredentials-page-heading">Login Credentials</p>
                <p className="">Technician email-id: technician@gmail.com</p>
                <p className="">password: password123</p>
                <p className="">Dentist email-id: dentist@gmail.com</p>
                <p className="">password: password123</p>
            </div>
        </div>
    );
